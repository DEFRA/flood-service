...
lab.experiment('Happy Route tests', () => {
  ...
  lab.test('13 - GET / route works for /stations-within-radius/{lng}/{lat}/{radiusM} ', async () => {
    ...
    const stub = mock.replace(services, 'getStationsByRadius', mock.makePromise(null, [
      {
        rloi_id: 7021,
        telemetry_id: '0470TH',
        region: 'Thames',
      ...
      },
      {
        ...
        catchment: 'Cotswolds',
        wiski_river_name: 'Ampney Brook',
        agency_name: 'Sheeppen Bridge',
        external_name: 'Sheeppen Bridge',
        station_type: 'M',
        status: 'Active',
        qualifier: 'd',
        iswales: false
  ...
  lab.test('14 - GET / route works for /stations-within/{x1}/{y1}/{x2}/{y2} ', async () => {
    const options = {
      method: 'GET',
    ...
    const stub = mock.replace(services, 'getStationsWithin', mock.makePromise(null, [
      {
        rloi_id: 7225,
        telemetry_id: '2989TH',
        region: 'Thames',
        catchment: 'Bournes',
        wiski_river_name: 'Addlestone Bourne',
        agency_name: 'Addlestone',
        external_name: 'Addlestone',
        station_type: 'S',
        status: 'Active',
        qualifier: 'u',
        iswales: false,
        value: '0.323',
        value_timestamp: '2019-07-24T12:15:00.000Z',
        value_erred: false,
        percentile_5: '0.7',
        percentile_95: '0.713'
      },
      {
        ...
        catchment: 'Bournes',
        wiski_river_name: 'Addlestone Bourne',
        agency_name: 'Grants Bridge',
        external_name: 'Grants Bridge',
        station_type: 'S',
        status: 'Active',
        qualifier: 'u',
        iswales: false,
